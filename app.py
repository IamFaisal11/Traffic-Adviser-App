...
# Load YOLOv8 models
yolov8_road_damage = YOLO(r'..\App\models\best (8).pt')
yolov8_aerial = YOLO(r'..\App\models\arielview.pt')
yolov8_traffic_light = YOLO(r'..\App\models\best (7).pt')
yolov8_road_object = YOLO(r'..\App\models\yolov8n.pt')  
